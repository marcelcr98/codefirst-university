...
namespace CodeFirstUniversity.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InstructorID,Location,Enabled")] OfficeAssignment officeAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InstructorID,Location,Enabled")] OfficeAssignment officeAssignment)
        {
            if (ModelState.IsValid)
            {
